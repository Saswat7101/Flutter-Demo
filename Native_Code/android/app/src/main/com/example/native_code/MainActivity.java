...
import android.os.BattreyManager;
...
public class MainActivity extends FlutterActivity {
    ...
    private int getBatteryLevel() {
        ...
        if(VERSION.SDK_INT >= VERSION_CODES.LOLLIPOP) {
            BattreyManager batteryManager = (BattreyManager) getSystemService(BATTERY_SERVICE);
            batteryLevel = batteryManager.getIntProperty(BattreyManager.BATTERY_PROPERTY_CAPACITY);
        } else {
